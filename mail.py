...
class Mail(QtWidgets.QWidget):
    ...
    def kontrol(self):
        ...
        Subject: {}
        {}
        """.format(self.mailim, self.alici, self.konu, self.mesaj)
        ...
        try:
            ...
            server.sendmail(self.mailim,self.email_text, self.mesaj.setText())  # Mail'imizi gönderdik
...
"""
# Hesap bilgilerimiz
kullanıcı = input("Mail adresinizi girin :")
kullanıcı_sifresi = input("Şifrenizi girin ")

alıcı = input("Alıcı mail giriniz :")  # alıcının mail adresi
konu = 'Selam'
msj = 'Naber!'
